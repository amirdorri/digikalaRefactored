...
import com.example.digikala.data.remote.CheckConnection.isNetworkAvailable
...
fun SplashScreen(navController: NavHostController) {
    ...
    Splash(isNetworkAvailable) {
        if (isNetworkAvailable(context)) {
            ...
            Toast.makeText(context, context.getString(R.string.check_net),Toast.LENGTH_SHORT).show()
        }
    }
